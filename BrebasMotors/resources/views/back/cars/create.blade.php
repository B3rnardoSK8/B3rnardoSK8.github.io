    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('back.cars.store') }}" enctype="multipart/form-data" class="car-form">
                    @csrf
                    @php
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="brandCustom" name="brand_custom" class="form-control mt-2 d-none" placeholder="Escreva a nova marca" value="{{ old('brand_custom') }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="modelCustom" name="model_custom" class="form-control mt-2 d-none" placeholder="Escreva o novo modelo" value="{{ old('model_custom') }}">
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="500" min="0" name="price" class="form-control" value="{{ old('price') }}" placeholder="Ex.: 85000" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Quilometragem</label>
                            <input type="number" id="mileageInput" min="0" name="mileage" class="form-control" value="{{ old('mileage', 0) }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Motor</label>
                            <input type="text" name="engine" id="engineInput" class="form-control car-auto-field" value="{{ old('engine') }}" placeholder="Selecionar modelo" readonly required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Potência (cv)</label>
                            <input type="number" min="0" name="power" id="powerInput" class="form-control car-auto-field" value="{{ old('power') }}" placeholder="Selecionar modelo" readonly required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Combustível</label>
                            <input type="hidden" name="fuel" id="fuelHidden" value="{{ old('fuel') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="hidden" name="transmission" id="transmissionHidden" value="{{ old('transmission') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" min="1" name="doors" id="doorsInput" class="form-control car-auto-field" value="{{ old('doors') }}" placeholder="Selecionar modelo" readonly required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Lugares</label>
                            <input type="number" min="1" name="seats" id="seatsInput" class="form-control car-auto-field" value="{{ old('seats') }}" placeholder="Selecionar modelo" readonly required>
                        </div>
                        <div class="col-md-6 mb-3">
            ...
            <script type="application/json" id="create-car-models-by-brand">{!! json_encode($catalogOptions['modelsByBrand']) !!}</script>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const modelsByBrand = JSON.parse(document.getElementById('create-car-models-by-brand').textContent);
    const specsByBrandModel = JSON.parse(document.getElementById('create-car-specs-by-brand-model').textContent);
    const selectedModel = JSON.parse(document.getElementById('create-car-selected-model').textContent);
    ...
    function renderModelOptions(brand, keepSelection = true) {
        ...
        models.forEach((model) => {
            ...
            if (keepSelection && selectedModel === model) {
    ...
    function updateConditionFromMileage() {
        ...
        const isNew = Number.isNaN(mileage) || mileage <= 10;
    ...
    brandSelect.addEventListener('change', function () {
        // toggle custom brand input
        if (this.value === '__add_brand') {
            brandCustom.classList.remove('d-none');
            brandCustom.required = true;
            // show custom model input as well
            setCustomModelSelection();
            modelCustom.classList.remove('d-none');
            modelCustom.required = true;
            // clear auto fields
            ...
            renderModelOptions(this.value, false);
        }
    });
